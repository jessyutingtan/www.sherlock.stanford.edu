...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Futuristic cold-tone color palette
        cyber: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#b9e6fe',
      ...
      keyframes: {
        ...
        glow: {
          ...
          '50%': { boxShadow: '0 0 30px rgba(14, 165, 233, 0.8), 0 0 40px rgba(14, 165, 233, 0.6)' },
        },
        float: {
        ...
        pulseGlow: {
          ...
          '50%': {
            boxShadow: '0 0 60px rgba(34, 211, 238, 0.9), 0 0 120px rgba(34, 211, 238, 0.5)',
          },
        },
      },
      backgroundImage: {
